...
$this->title = Yii::t('frontend', 'Trang không tồn tại');
$this->context->layout = 'fullWidth';
    ...
    <div class="container py-5 mb-lg-3">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-8 col-lg-10">
          <div class="row">
            <div class="col-sm-4 mb-3"><a class="card h-100 border-0 shadow-sm bg-gray-2 text-light" href="index.html">
                <div class="card-body">
            ...
            <div class="col-sm-4 mb-3"><a class="card h-100 border-0 shadow-sm  bg-gray-2 text-light" href="#">
                <div class="card-body">
            ...
            <div class="col-sm-4 mb-3"><a class="card h-100 border-0 shadow-sm  bg-gray-2 text-light"
