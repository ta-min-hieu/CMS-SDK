...
class DepartmentSearch extends Department
{
    ...
    {
        return [
            [['id_department', 'department_name', 'address', 'management_id', 'village', 'district', 'province', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'department_name', $this->department_name])
            ...
            ->andFilterWhere(['like', 'management_id', $this->management_id]);
