...
/**
 * UserLockedSearch represents the model behind the search form about `backend\models\UserLocked`.
 */
class UserLockedSearch extends UserLocked
{
    /**
     * @inheritdoc
     */
