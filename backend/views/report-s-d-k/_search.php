    ...
    <div class="panel-body row">
        ...
        <div class="col-md-3">
            <?= $form->field($model, 'id_department')->widget(Select2::classname(), [
                'initValueText' => '',
                'options' => ['placeholder' => Yii::t('backend', 'Tìm theo mã hoặc tên department')],
                'pluginOptions' => [
                    'allowClear' => true,
        ...
        <div class="col-md-3">
            <?= $form->field($model, 'id_province')->widget(Select2::classname(), [
                // 'initValueText' => '',
                'options' => ['placeholder' => Yii::t('backend', 'Tìm tỉnh/thành phố')],
                'pluginOptions' => [
                    'allowClear' => true,
                    'minimumInputLength' => 1,
                    'language' => [
                    ...
                    'ajax' => [
                        'url' => \yii\helpers\Url::toRoute(['report-s-d-k/ajax-search-province']),
                        'dataType' => 'json',
                        'data' => new JsExpression('function(params) { return {q:params.term }; }')
                    ],
                    'escapeMarkup' => new JsExpression('function (markup) { return markup; }'),
            ...
            ])->label(Yii::t('backend', 'Tỉnh/Thành Phố')); ?>
        </div>
        <?php } ?>
        <div class="col-md-3">
            <?php echo
