...
class MemCached {
     ...
     */
    public function addServers($cache, $servers)
    {
        if (empty($servers)) {
     ...
     * @param MemCacheServer[] $servers
     */
    public function addMemcachedServers($cache, $servers)
    {
        $existingServers = [];
     ...
     * @param MemCacheServer[] $servers
     */
    public function addMemcacheServers($cache, $servers)
    {
     ...
     */
    public function trimDuration($duration)
    {
        if ($duration > 2592000) {
