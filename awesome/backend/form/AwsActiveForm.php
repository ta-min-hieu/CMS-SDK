...
class AwsActiveForm extends Widget
{
    /**
     ...
     * @see fieldConfig
     */
    public $fieldClass = 'awesome\backend\form\AwsActiveField';
    /**
    ...
    /**
     * @var AwsActiveField[] the ActiveField objects that are currently active
     */
    private $_fields = [];
    ...
    public function run()
    {
        ...
        if ($this->enableClientScript) {
            ...
            $view = $this->getView();
            AwsActiveFormAsset::register($view);
     ...
     * @return AwsActiveField the created ActiveField object
     * @see fieldConfig
     */
    ...
    public function endField()
    {
        ...
        if ($field instanceof AwsActiveField) {
            return $field->end();
        } else {
