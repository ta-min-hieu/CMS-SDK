...
namespace awesome\backend\widgets;
 ...
 * @since 2.0
 */
class AwsLayoutMenu extends Menu
{
    /**
     ...
     */
    public $linkTemplate = '<a href="{url}" class="nav-link nav-toggle"><i class="{icon}"></i> <span class="title">{label}</span></a>';
    /**
     ...
     * This property will be overridden by the `template` option set in individual menu items via [[items]].
     */
    public $labelTemplate = '<a href="javascript:;" class="nav-link nav-toggle"><i class="{icon}"></i> <span class="title">{label}</span><span class="arrow"></span></a>';
    /**
     * @var string the template used to render the body of a menu which is NOT a link.
    ...
    /**
     * @var string the default icon in label
     */
    public $defaultIcon = 'icon-folder';
    /**
