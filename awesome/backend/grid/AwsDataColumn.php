        ...
        if ($this->filter !== false && $model instanceof Model && $this->attribute !== null && $model->isAttributeActive($this->attribute)) {
            ...
            if ($widgetClass) {
                ...
                if (is_array($this->filter)) {
                    if (Config::isInputWidget($this->filterType) && $this->grid->pjaxContainerId) {
                        $options['pjaxContainerId'] = $this->grid->pjaxContainerId;
                    }
                    if ($this->filterType === AwsGridView::FILTER_TYPE_SELECT2 || $this->filterType === AwsGridView::FILTER_TYPE_TYPEAHEAD) {
                        $options['data'] = $this->filter;
                    }
                    if ($this->filterType === AwsGridView::FILTER_TYPE_RADIO) {
                        return AwsBaseHtml::activeRadioList(
                ...
                if ($this->filterType === AwsGridView::FILTER_TYPE_CHECKBOX) {
                    return AwsBaseHtml::activeCheckbox($this->grid->filterModel, $this->attribute, $this->filterInputOptions);
                }
            ...
            return AwsBaseHtml::activeTextInput($model, $this->attribute, $this->filterInputOptions);
        }
