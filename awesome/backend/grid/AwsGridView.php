...
class AwsGridView extends AwsBaseListView
{
     ...
     */
    public $tableOptions = [
        'class' => 'table table-striped table-bordered table-hover table-header-fixed dataTable no-footer',
        'role' => 'grid'
    ];
    /**
     ...
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
    public $headerRowOptions = ['class' => '', 'role' => 'row'];
    /**
     ...
     */
    public $formatter = 'awesome\backend\grid\AwsFormatter';
    /**
    ...
    /**
     * @var string Id of the container pjax
     */
    ...
    public function init()
    {
        ...
        } elseif (is_string($this->formatter) || is_array($this->formatter)) {
