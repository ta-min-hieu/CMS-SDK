...
//        $listHtml = Html::dropDownList('per-page', $perPage, $this->sizes, $this->options);
        ...
        $listHtml = AwsBaseHtml::dropDownList('per-page', $perPage, $pageSize, $this->options);
        $label1Html = AwsBaseHtml::label($this->label1, $this->options['id'], $this->label1Options);
        $label2Html = AwsBaseHtml::label($this->label2, $this->options['id'], $this->label2Options);
